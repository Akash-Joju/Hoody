...
export default function Home() {
  ...
  const defaultProducts: Product[] = [
    ...
    { name: 'Steep AJ Hoodie', price: 1599, image: 'https://i.pinimg.com/1200x/3b/0c/4e/3b0c4e4faf56c7e478ea6691dea29d27.jpg' },
    { name: 'Nikton Hoodie', price: 2399, image: 'https://i.pinimg.com/1200x/c7/f0/69/c7f069ba8881f8bd6c4771c8dda6d6ec.jpg' },
  ];

  const defaultHero = {
    tagline: 'Limited Edition Hoodies. Drop Yours Today.',
    background: 'https://i.pinimg.com/originals/a5/b3/b0/a5b3b00b226839be5c98d1c081aaea67.gif',
  };
      ...
      <section className="relative min-h-[80vh] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-6">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            <Typewriter
              options={{
                strings: [hero.tagline, 'Only This Season', 'Get Yours Now'],
                autoStart: true,
                loop: true,
              }}
            />
        ...
        <Slider {...sliderSettings}>
          {defaultProducts.map((item, i) => (
            <motion.div
              key={i}
              className="px-4"
              animate={{ scale: [0.8, 1.1, 0.8], rotateY: [0, 20, 0], opacity: [0.7, 1, 0.7] }}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {products.map((p, idx) => (
            <motion.div
              ...
              whileTap={{ scale: 1.02 }}
              className="bg-white border border-gray-200 rounded-2xl shadow-md hover:shadow-xl transition-transform"
            >
              ...
              <div className="p-4 text-center space-y-2">
                ...
                <a href={`https://wa.me/?text=I want to order: ${p.name}`} className="block bg-black text-white py-2 rounded-xl shadow hover:bg-gray-800 transition">
                  🛒 Order Now
                </a>
              </div>
            </motion.div>
